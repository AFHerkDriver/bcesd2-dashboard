/* ═══════════════════════════════════════════════════════════════════
   ...
   CACHE: bc2fd-dash-v181   ← BUMP THIS ON EVERY DEPLOY (v1 → v2 → …)
...
var SHELL = ['./', 'cameras.json', 'index.html', 'control.html', 'metrics.html', 'mdt.html', 'fleet.html', 'report.html',
             ...
             'le-eagle.png', 'le-eagle@2x.png', 'le-dps.png', 'le-dps@2x.png', 'le-poacher.png', 'le-poacher@2x.png',   /* vendored libs: the map draws with zero CDN reachability */
