/* ═══════════════════════════════════════════════════════════════════
   ...
   CACHE: bc2fd-dash-v173   ← BUMP THIS ON EVERY DEPLOY (v1 → v2 → …)
...
var SHELL = ['./', 'cameras.json', 'index.html', 'control.html', 'metrics.html', 'mdt.html', 'fleet.html', 'report.html',
             ...
             'vendor/images/layers.png', 'vendor/images/layers-2x.png',   /* the layers-control button IS an image — vendoring the css without these broke the button on every map */,   /* vendored libs: the map draws with zero CDN reachability */
